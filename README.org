...
#+TITLE: SHELF Rationale and Practice
...
rationale for the  standard, it is the reader's guide  to the function
families which support  an implementation of the  standard.  The novel
feature of the implementation is  the /function family/.  This feature
introduces nothing new  to shell syntax or ability  to access function
libraries.  It  does set a  practice to organize  function collections
inside a function library.

Enabled by the /function family/,  a ~shelflib~ contains four function
families  and a  utility group  to support  the SHELF  standard.  Each
family and group has a separate user guide.

* Families

These are the four families and utility group of functions.  Each section
introduces the family or group to indentify it's distinct purpose in 
support of the  [[./shelf.org][SHELF Standard]].   The next section introduces the 
...
* <<mflibinit>>Multi-family libraries
